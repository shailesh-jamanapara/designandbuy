...
Globals.PLUGINS.themePluginFixTo = function(context) {
  ...
  if ($fixTos.length > 0) {
    ...
    $document.themeLoadPlugin(
      ["https://cdnjs.cloudflare.com/ajax/libs/fixto/0.5.0/fixto.js"], ["http://13.234.247.143/mj/assets/plugins/plugin-css/plugin-sticky-classes.min.css"],
...
Globals.PLUGINS.themePluginOwlCarousel = function(context) {
  ...
  if ($owlCarousels.length > 0) {
    ...
    $document.themeLoadPlugin(
      ["https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.2.1/owl.carousel.min.js"], ["http://13.234.247.143/mj/assets/plugins/plugin-css/plugin-owl-carousel.min.css", "https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.2.1/assets/owl.carousel.min.css", "https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css"],
