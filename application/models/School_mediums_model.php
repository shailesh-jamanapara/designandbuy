...
class School_Mediums_Model Extends Designandbuy_Model {
    ...
    private function setTableProperties() {
        $this->table_properties = array(
            'fields' => array(
                ...
                'school_medium_name' => array(
                    'caption' => array('school medium', 'school medium', 'school medium'),
                    'type' => 'varchar',
                    'len' => 50,
                    'is_fk' => true,
                    'value' => null,
                    'rules' => array('is_required' => false, 'regex' => array('server' => '/[^a-zA-Z.\ ]', 'client' => '', 'message' => 'Allowed only Characters(A-Z) & Numbers(0-10000).')),
                    'in_select' => 1,
                    'in_insert' => 1,
                    'help' => 'e.g. ZZ0000SS',
                ),
    ...
    /*
     * Public function getAll of Users_Officials_Model class
     * @param integer $page
     * @param integer $limit
     * @param array $obArr 
    ...
    /*
     * Public function getById of Users_Officials_Model class
     * @param integer $id
     * @return array of result
     */
    ...
    /*
     * Public function save_record of Users_Officials_Model class
     * 
     */
    ...
    /*
     * Public function getAllWithKeyValue of Users_Officials_Model class
     * 
     */
    ...
    /*
     * Public function getAllId of Users_Officials_Model class
     * 
     */
    ...
    /*
     * Public function softDelete of Users_Officials_Model class
     * 
     */
