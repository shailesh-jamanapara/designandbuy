...
class Attributes_Model Extends Designandbuy_Model {
        ...
        $this->table_properties = array(
            'fields' => array(
                ...
                'attribute_name' => array(
                    'caption' => array('attribute_name name', 'attribute_name name', 'attribute_name name'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
				...
				'show_in_catalog' => array(
                    'caption' => array('show_in_catalog name', 'show_in_catalog name', 'show_in_catalog name'),
                    'type' => 'int',
                    'len' => 1,
                    'value' => 1,
                    'rules' => array('is_required' => true),
				...
				'sort_order' => array(
					'caption' => array('sort_order', 'sort_order ', 'sort_order'),
					'type' => 'int',
					'len' => 1,
					'labels' => array('Yes', 'No'),
					'rules' => array('is_required' => true),
