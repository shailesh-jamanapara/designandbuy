...
class System_Modules_model Extends Vect_Model {
        ...
        $this->table_properties = array(
            'fields' => array(
                ...
                'parent_module_name' => array(
                    ...
                    'in_select' => 1,
                    'in_insert' => 0,
                    'modified' => ' pm.system_module_name as parent_module_name',
                ),
                ...
                'module_action' => array(
                    'caption' => array('module action name', 'module action name', 'module action name'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
                ...
                'module_sub_action' => array(
                    'caption' => array('module sub action name', 'module sub action name', 'module sub action name'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
            ...
            'join_tables' => array(
                0 => array('system_modules as pm', 'pm.id = ' . $this->getTable() . '.parent_id ', 'left')
            )
        );
    }
    ...
    /*
     * Public function getAll of System_Modules_model class
     * @param integer $page
     * @param integer $limit
     * @param array   $obArr 
    ...
    /*
     * Public function getById of System_Modules_model class
     * @param integer $id
     * @return array of result
     */
    ...
    /*
     * Public function save_record of System_Modules_model class
     * 
     */
  public function save_record($id, $data = array()) {
    ...
    /*
     * Public function getAllWithKeyValue of System_Modules_model class
     * 
     */
    ...
    /*
     * Public function getAllId of System_Modules_model class
     * 
     */
    ...
    /*
     * Public function softDelete of System_Modules_model class
     * 
     */
