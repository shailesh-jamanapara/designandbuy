...
class Product_Categories_Model Extends Designandbuy_Model {
        ...
        $this->table_properties = array(
            'fields' => array(
                ...
                'product_category_name' => array(
                    'caption' => array('category name', 'category name', 'category name'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
                ...
                'category_slug' => array(
                    'caption' => array('category_slug name', 'category_slug name', 'category_slug name'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
				 ...
				 'category_image' => array(
                    'caption' => array('category_image', 'category_image', 'category_image'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
