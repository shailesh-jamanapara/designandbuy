...
class Attribute_Options_Model Extends Designandbuy_Model {
            ...
            'fields' => array(
				...
				'attribute_id' => array(
				 ...
				 'attribute_name' => array(
                    'caption' => array('attribute_name', 'attribute_name', 'attribute_name'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
                    'in_select' => 1,
                    'in_insert' => 0,
					'modified'=>' attributes.attribute_name as attribute_name'
                ),
                'attribute_option_name' => array(
                    'caption' => array('attribute_option_name name', 'attribute_option_name name', 'attribute_option_name name'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
				...
				'attribute_option_value' => array(
                    'caption' => array('attribute_option_value name', 'attribute_option_value name', 'attribute_option_value name'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
				...
				'is_required' => array(
                    'caption' => array('is_required name', 'is_required name', 'is_required name'),
                    'type' => 'int',
                    'len' => 1,
                    'value' => 1,
                    'rules' => array('is_required' => true),
			 ...
			 'join_tables' => array(
                0 => array('attributes', 'attributes.id = ' . $this->getTable() . '.attribute_id ', 'left')
            ),
            'where' => array()
        );
    }
