...
class States_Model Extends Designandbuy_Model {
    ...
    private function setTableProperties() {
        $this->table_properties = array(
            'fields' => array(
                ...
                'state_name' => array(
                    'caption' => array('position name', 'position name', 'position name'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
                ...
                'country_name' => array(
                    'caption' => array('country name', 'country name', 'country name'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
                    'in_select' => 1,
                    'in_insert' => 0,
                    'modified' => ' countries.country_name as country_name'
                ),
                'status' => array(
    ...
    public function setWhere() {
        if (isset($this->table_properties['where']) && !empty($this->table_properties['where'])) {
            $this->ci_where = $this->table_properties['where'];
        }
    }

    /*
     * Public function getAll of States_Model class
     * @param integer $page
     * @param integer $limit
     * @param array   $obArr 
    ...
    /*
     * Public function getById of States_Model class
     * @param integer $id
     * @return array of result
     */
    ...
    /*
     * Public function save_record of States_Model class
     * 
     */
  ...
  public function save_record($id, $data = array()) {
    ...
    /*
     * Public function getAllWithKeyValue of States_Model class
     * 
     */
    ...
    /*
     * Public function softDelete of States_Model class
     * 
     */
