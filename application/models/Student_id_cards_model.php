...
class Student_Id_Cards_Model Extends Designandbuy_Model {
        ...
        $this->table_properties = array(
            'fields' => array(
                ...
                'students_id' => array(
				 ...
				 'schools_id' => array(
                    'caption' => array('Schools ID', 'Schools ID', 'Schools ID'),
                    'type' => 'int',
                    'len' => 4,
                    'is_fk' => true,
                    'value' => null,
                ...
                'customer_templates_id' => array(
                    'caption' => array('Templates Id', 'Templates ID', 'Templates ID'),
                    'type' => 'int',
                    'len' => 4,
                    'is_fk' => true,
                    'value' => null,
                ...
                'templates_data_json' => array(
                    'caption' => array('Templates  data', 'Templates  data', 'Templates  data'),
                    'type' => 'varchar',
                    'len' => 100000,
                    'value' => null,
                    'rules' => array('is_required' => true),
                ...
                'id_card_json' => array(
                    'caption' => array('Templates  data ', 'Students data', 'Students data'),
                    'type' => 'varchar',
                    'len' => 100000,
                    'value' => null,
                    'rules' => array('is_required' => true),
                ...
                'id_card_json_back' => array(
                    'caption' => array('Students data back side', 'Students data back side', 'Students data back side'),
                    'type' => 'varchar',
                    'len' => 100000,
                    'value' => null,
                    'rules' => array('is_required' => true),
                ...
                'id_card_svg_path' => array(
                    'caption' => array('id_card_svg_path', 'id_card_svg_path', 'id_card_svg_path'),
                    'type' => 'varchar',
                    'len' => 250,
                    'value' => null,
                    'rules' => array('is_required' => true),
                ...
                'id_card_svg_path_back' => array(
                    'caption' => array('id_card_svg_path_back', 'id_card_svg_path_back', 'id_card_svg_path_back'),
                    'type' => 'varchar',
                    'len' => 250,
                    'value' => null,
                    'rules' => array('is_required' => true),
                ...
                'academic_year' => array(
                    'caption' => array('academic_year', 'academic_year', 'academic_year'),
                    'type' => 'varchat',
                    'len' => 50,
                    'is_fk' => true,
                    'value' => null,
