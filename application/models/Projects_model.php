...
class Projects_Model Extends Designandbuy_Model {
    ...
    private function setTableProperties() {
        $this->table_properties = array(
            'fields' => array(
                ...
                'project_short_description' => array(
                    'caption' => array('project_short_description', 'project_short_description', 'project_short_description'),
                    'type' => 'varchar',
                    'len' => 1000,
                    'value' => null,
                    'rules' => array('is_required' => true),
