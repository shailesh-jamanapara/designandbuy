...
class Documents_Model Extends Designandbuy_Model {
    ...
    private function setTableProperties() {
        $this->table_properties = array(
            'fields' => array(
                ...
                'document_name' => array(
                    'caption' => array('document name', 'document name', 'document name'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
    ...
    /*
     * Public function getAll of Documents_Model class
     * @param integer $page
     * @param integer $limit
     * @param array   $obArr 
    ...
    /*
     * Public function getById of Documents_Model class
     * @param integer $id
     * @return array of result
     */
    ...
    /*
     * Public function save_record of Documents_Model class
     * 
     */
    ...
    /*
     * Public function getAllWithKeyValue of Documents_Model class
     * 
     */
    ...
    /*
     * Public function softDelete of Documents_Model class
     * 
     */
