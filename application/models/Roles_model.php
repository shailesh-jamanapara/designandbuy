...
class Roles_Model Extends Designandbuy_Model {
        ...
        $this->table_properties = array(
            'fields' => array(
                ...
                'role_description' => array(
                    'caption' => array('Role Description', 'Role Description', 'Role Description'),
                    'type' => 'varchar',
                    'len' => 255,
                    'value' => null,
                    'rules' => array('is_required' => true),
    ...
    /*
     * Public function getById of Roles_Model class
     * @param integer $id
    ...
    /*
     * Public function save_record of Roles_Model class
     * 
     */
 ...
 /*
     * Public function getAllWithKeyValue of Roles_Model class
     * 
     */
    ...
    /*
     * Public function softDelete of Roles_Model class
     * 
     */
