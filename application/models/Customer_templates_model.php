...
class Customer_Templates_Model Extends Designandbuy_Model {
    ...
    private function setTableProperties() {
        $this->table_properties = array(
            'fields' => array(
                ...
                'customers_id' => array(
                    'caption' => array('customers_id ID', 'customers_id ID*', 'customers_id ID*'),
                    'type' => 'int',
                    'len' => 4,
                    'is_fk' => true,
                    'value' => null,
                ...
                'templates_id' => array(
                    'caption' => array('templates_id ID', 'templates_id ID*', 'templates_id ID*'),
                    'type' => 'int',
                    'len' => 4,
                    'is_fk' => true,
                    'value' => null,
			 ...
			 'template_name' => array(
                ...
                'template_unique_id' => array(
                    'caption' => array('template_unique_id ID', 'template_unique_id ID', 'template_unique_id ID'),
                    'type' => 'varchar',
                    'len' => 250,
                    'is_fk' => true,
                    'value' => null,
				...
				'template_data_json' => array('caption' => array('Fields', 'Fields ', 'Fields'), 'type' => 'varchar', 'len' => 100, 'value' => null, 'rules' => array('is_required' => true), 'in_select' => 1, 'in_insert' => 1, ),
                'template_data_json_back' => array('caption' => array('Fields', 'Fields ', 'Fields'), 'type' => 'varchar', 'len' => 100, 'value' => null, 'rules' => array('is_required' => true), 'in_select' => 1, 'in_insert' => 1, ),
                
                'template_fields' => array('caption' => array('Fields', 'Fields ', 'Fields'), 'type' => 'varchar', 'len' => 1000, 'value' => null, 'rules' => array('is_required' => true), 'in_select' => 1, 'in_insert' => 1, ),
                'template_variables' => array('caption' => array('Fields', 'Fields ', 'Fields'), 'type' => 'varchar', 'len' => 10000, 'value' => null, 'rules' => array('is_required' => true), 'in_select' => 1, 'in_insert' => 1, ),
                'template_variables_back' => array('caption' => array('Fields', 'Fields ', 'Fields'), 'type' => 'varchar', 'len' => 10000, 'value' => null, 'rules' => array('is_required' => true), 'in_select' => 1, 'in_insert' => 1, ),
                
                'template_fields_back' => array('caption' => array('Fields', 'Fields ', 'Fields'), 'type' => 'varchar', 'len' => 1000, 'value' => null, 'rules' => array('is_required' => true), 'in_select' => 1, 'in_insert' => 1, ),
                'template_preferences' => array('caption' => array('Fields', 'Fields ', 'Fields'), 'type' => 'varchar', 'len' => 1000, 'value' => null, 'rules' => array('is_required' => true), 'in_select' => 1, 'in_insert' => 1, ),
                'template_svg' => array('caption' => array('Fields', 'Fields ', 'Fields'), 'type' => 'varchar', 'len' => 10000, 'value' => null, 'rules' => array('is_required' => true), 'in_select' => 1, 'in_insert' => 1, ),
                'template_svg_back' => array('caption' => array('Fields', 'Fields ', 'Fields'), 'type' => 'varchar', 'len' => 10000, 'value' => null, 'rules' => array('is_required' => true), 'in_select' => 1, 'in_insert' => 1, ),
                ...
                'template_type' => array(
                    'caption' => array('Template type', 'template type', 'template type'),
                    'type' => 'int',
                    'len' => 4,
                    'is_fk' => true,
                    'value' => null,
                    'table' => 'customers_templates',
                    'rules' => array('is_required' => true),
                    'in_select' => 1,
                    'in_insert' => 1
                ),
    ...
    public function getAllWithKeyValue( $obArr=array() ) {
        ...
        if (!empty($rows) && count($rows) > 0) {
            foreach ($rows as $row) {
                ...
                $rowArr[$row['id']] = $row['template_name'];
            }
        }
        return $rowArr;
    }
