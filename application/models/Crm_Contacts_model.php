    ...
    private function setTableProperties() {
        $this->table_properties = array(
            'fields' => array(
                ...
                'crm_contact_name' => array(
                    'caption' => array('Name', 'Name*', 'Name*'),
                    'type' => 'varchar',
                    'len' => 255,
                    'is_fk' => true,
                    'value' => null,
                ...
                'contact_subject' => array(
                    'caption' => array('Inquiry Subject', 'Inquiry Subject*', 'Inquiry Subject*'),
                    'type' => 'text',
                    'len' => 1000,
                    'is_fk' => true,
                    'value' => null,
                ...
                'contact_number' => array(
                    'caption' => array('Phone', 'Phone', 'Phone'),
                    'type' => 'int',
                    'len' => 11,
                    'is_fk' => true,
                    'value' => null,
                ...
                'contact_message' => array(
                    'caption' => array('Message', 'Message*', 'Message*'),
                    'type' => 'text',
                    'len' => 1000,
                    'is_fk' => true,
                    'value' => null,
                ...
                'contact_for' => array(
                    'caption' => array('Inquiry For', 'Inquiry For*', 'Inquiry For'),
                    'type' => 'enum',
                    'len' => array(1, 0),
                ...
                'created_by' => array(
                    'caption' => array('Created By ID', 'Created By ID', 'Created By ID'),
                    'type' => 'int',
                    'len' => 10,
                    'value' => null,
                    'rules' => array('is_required' => true),
