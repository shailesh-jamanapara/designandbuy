...
class Template_Attribute_Options_Model Extends Designandbuy_Model {
    ...
    private function setTableProperties() {
        $this->table_properties = array(
            'fields' => array(
				...
				'attribute_option_id' => array(
                    'caption' => 'attribute_option_id',
                    'type' => 'int',
                    'len' => 11,
                    'value' => null,
                    'is_pk' => true,
			 ...
			 'join_tables' => array(
                ...
                1 => array('attribute_options', 'attribute_options.id = ' . $this->getTable() . '.attribute_option_id ', 'left')
            ),
            'where' => array()
        );
    }
