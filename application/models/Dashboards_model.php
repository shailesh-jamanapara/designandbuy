...
class Dashboards_Model Extends Designandbuy_Model {
    ...
    private function setTableProperties() {
        $this->table_properties = array(
            'fields' => array(
                ...
                'setup_name' => array(
                    'caption' => array('Role name', 'Role name', 'Role name'),
                    'type' => 'varchar',
                    'len' => 100,
                    'value' => null,
                    'rules' => array('is_required' => true),
    ...
    /*
     * Public function getAll of Dashboards_Model class
     * @param integer $page
     * @param integer $limit
     * @param array   $obArr 
    ...
    /*
     * Public function getById of Dashboards_Model class
     * @param integer $id
     * @return array of result
     */
    ...
    /*
     * Public function save_record of Dashboards_Model class
     * 
     */
    ...
    /*
     * Public function getAllWithKeyValue of Dashboards_Model class
     * 
     */
    ...
    /*
     * Public function softDelete of Dashboards_Model class
     * 
     */
