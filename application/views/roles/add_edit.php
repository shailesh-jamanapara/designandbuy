				  ...
				  <form class="form-horizontal form-label-left" novalidate method="post" action="" id="editform" data-bv-message="This value is not valid" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" enctype="multipart/form-data">
					...
					<input type="hidden" name="limit" id="limit" value="<?php echo $postdata['limit']; ?>" />
					 <div class="row row-edit-form">
						<div class="col-lg-6"> 
							<label class="control-label col-lg-4 col-md-4 label-title-upper" for="role_name"><span class="requireds">*</span> Role Name:</label>
							<div class="col-lg-8 col-sm-6 col-xs-12 form-group">
									<input type="text" class="form-control" name="role_name" id="role_name" placeholder="Role name" value="<?php echo $row['role_name']; ?>"
									data-bv-notempty="true" data-bv-notempty-message="Please enter role name"
									>
							</div>
						</div>
					  </div>
					  <div class="row row-edit-form">
						<div class="col-lg-6"> 
							<label class="control-label col-lg-4 col-md-4 label-title-upper" for="role_description"><span class="requireds">*</span> Role  Description :</label>
							<div class="col-lg-8 col-sm-6 col-xs-12 form-group">
									<textarea type="text" class="form-control" name="role_description" id="role_description" placeholder="Role description"
									data-bv-notempty="true" data-bv-notempty-message="Please enter role description"
									><?php if(isset($row['role_description'])) echo $row['role_description']; ?></textarea>
							</div>
						</div>
					  </div>
					  <div class="row row-edit-form">
