			  ...
			  <form class="form-horizontal" name="frmsearch" id="frmsearch" method="post" action="" >
				...
				<table class="table table-striped jambo_table bulk_action" >
					...
					<tr>
						...
						<th class="column-title col-lg-3 text-primary sortable" column="educational_qualifications.educational_qualification_name" state="none"  >Qualification Name<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-2 text-primary " > Stream Requires </th>
						<th class="column-title col-lg-2 sortable" column="educational_qualifications.status" state="none" >Status<i   class="fa fa-sort-alpha-asc"> </i></th>
					...
					<tbody>
						...
						<?php  $stream_id = ( $row['stream_id'] == 1) ? '<span class="text-success"> <i class="fa fa-check" > </i> </span>': '<span class="text-warning"><i class="fa fa-close"> </i> </span>';
					  ?>
						<tr id="<?php echo $row_id; ?>">
						<td><?php echo  $i; ?></td>
						<td><?php echo  $row['educational_qualification_name']; ?></td>
						<td><?php  echo $stream_id; ?></td>
					...
					<?php  $i++; endforeach; endif; ?>
						<?php  if(empty($rows)) : ?> <td colspan="4" class="text-center" > No record found </td> <?php endif; ?>
					<tbody>
					</table>
