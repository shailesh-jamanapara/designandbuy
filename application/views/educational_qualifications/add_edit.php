				  ...
				  <form class="form-horizontal form-label-left" novalidate method="post" action="" id="editform" data-bv-message="This value is not valid" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" enctype="multipart/form-data">
					...
					<input type="hidden" name="limit" id="limit" value="<?php echo $postdata['limit']; ?>" />
					 <div class="row row-edit-form">
						<div class="col-lg-6"> 
							<label class="control-label col-lg-4 col-md-4 label-title-upper" for="educational_qualification_name"><span class="requireds">*</span> Qualification Name:</label>
							<div class="col-lg-8 col-sm-6 col-xs-12">
									<input type="text" class="form-control" name="educational_qualification_name" id="educational_qualification_name" placeholder="Qualification name" value="<?php echo $row['educational_qualification_name']; ?>"
									required
									>
							</div>
						</div>
					   ...
					   <div class="row row-edit-form">
					   <div class="col-lg-6"> 
							<label class="control-label col-lg-4 col-md-4 label-title-upper" for="educational_qualification_name"><span class="requireds">*</span> Required Stream:</label>
							<div class="col-lg-8 col-sm-6 col-xs-12">
									<label class="control-label label-title-upper candidate_type" for="stream_id1">
													<input  type="radio" class="flat form-control" name="stream_id" id="stream_id1" value="1" <?php if($row['stream_id'] == '1') echo 'checked="checked"';  ?>  /> Yes
									</label>&nbsp;
									<label class="control-label label-title-upper candidate_type" for="stream_id0">
													<input   type="radio" class="flat form-control" name="stream_id" id="stream_id0" value="0" checked="checked" <?php if($row['stream_id'] == '0') echo 'checked="checked"';  ?> /> No
									</label>	
							</div>
						</div>
					   </div>
