			  ...
			  <form class="form-horizontal" name="frmsearch" id="frmsearch" method="post" action="" >
				...
				<table class="table table-striped jambo_table bulk_action" >
					...
					<tr>
						...
						<th class="column-title col-lg-4 text-primary sortable" column="skills.skill_name" state="none"  >Skill Name<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-2 sortable" column="skills.status" state="none" >Status<i   class="fa fa-sort-alpha-asc"> </i></th>
