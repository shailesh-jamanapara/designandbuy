			  ...
			  <form class="form-horizontal" name="frmsearch" id="frmsearch" method="post" action="" >
				...
				<table class="table table-striped jambo_table bulk_action" >
					...
					<tr>
						...
						<th class="column-title col-lg-2 text-primary sortable" column="leave_types.leave_type_name" state="none"  >Leave Type<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-3 text-primary sortable" column="leave_types.short_code" state="none"  >Leave Type Code<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-2 sortable" column="leave_types.status" state="none" >Status<i   class="fa fa-sort-alpha-asc"> </i></th>
