			  ...
			  <form class="form-horizontal" name="frmsearch" id="frmsearch" method="post" action="" >
				...
				<table class="table table-striped jambo_table bulk_action" >
					...
					<tr>
						...
						<th class="column-title col-lg-3 text-primary sortable" column="positions.position_name" state="none"  >Position Name<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-4 text-primary sortable" column="departments.department_name" state="none"  >Department<i   class="fa fa-sort-alpha-asc"> </i></th>
