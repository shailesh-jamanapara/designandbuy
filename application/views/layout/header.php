...
<head>
  ...
  <title>MuktJeevan Pixcel | Dashboard</title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-mini"><b>M</b>Pixel</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Mukt Jivan</b>Pixel</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Admin, Mukt Jeevan Pixels</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url(); ?>index.php/User_Login/logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <form action="#" method="get" class="sidebar-form">
        <div class="input-group">
          <input type="text" name="search_text" id="search_text" onkeyup="searchMenu()" class="form-control" placeholder="Search...">
	  ...
	  <li><a href="<?php echo base_url(); ?>index.php/dashboards"><i class="fa fa-dashboard"></i> Dashboard </a>
