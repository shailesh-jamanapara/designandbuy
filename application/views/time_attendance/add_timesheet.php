            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" novalidate method="post" id="Event_Form" action="<?php echo base_url(); ?>index.php/time_attendance/add_timesheet_insert">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input  name="Emp_In_time" class="form-control col-md-7 col-xs-7 Emp_In_time"  type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input  name="Emp_Out_time" class="form_datetime form-control col-md-7 col-xs-7 Emp_Out_time"  type="text">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <input  name="Emp_Total_Hours" class="form-control col-md-7 col-xs-7 Emp_Total_Hours"  type="text">
                                </div>
                            </div>
