			  ...
			  <form class="form-horizontal" name="frmsearch" id="frmsearch" method="post" action="" >
				...
				<table class="table table-striped jambo_table bulk_action" >
					...
					<tr>
						...
						<th class="column-title col-lg-3 text-primary sortable" column="cities.city_name" state="none"  >City Name<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-3 text-primary sortable" column="states.state_name" state="none"  >State <i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-3 text-primary sortable" column="countries.country_name" state="none"  >Country<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-2 sortable" column="cities.status" state="none" >Status<i   class="fa fa-sort-alpha-asc"> </i></th>
					...
					<tbody>
						...
						<?php  if(empty($rows)) : ?> <td colspan="6" class="text-center" > No record found </td> <?php endif; ?>
					<tbody>
					</table>
