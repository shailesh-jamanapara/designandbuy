...
<html lang="en">
  <head>
        ...
        <link rel="stylesheet" href="<?php echo asset_url(); ?>build/css/bootstrap-timepicker.css" />
		 <link href="<?php echo asset_url(); ?>build/js/tagsinput/bootstrap-tagsinput.css" rel="stylesheet">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
				<a href="<?php echo base_url(); ?>index.php/dashboards" class="site_title">
			...
			<div class="profile clearfix">
				<div class="profile_pic">
					<img  src="<?php echo base_url(); ?><?php echo get_profile_pic(); ?>" alt="<?php echo login_username(); ?>" class="img-circle profile_img">
				</div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
					<ul class="nav side-menu">
						<li><a href="<?php echo base_url(); ?>index.php/dashboards"><i class="fa fa-desktop"></i> Dashboard </a>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="">
						<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
							<img   src="<?php echo base_url(); ?><?php echo get_profile_pic(); ?>" alt="<?php echo login_username(); ?>"> Welcome, 
							<?php
								echo login_username();
							?>
						...
						<ul class="dropdown-menu dropdown-usermenu pull-right">
							<li><a href="javascript:void(0);" onclick="javascript:viewprofile( '<?php echo  get_user_id();?>', '<?php echo base_url(); ?>index.php/users/my_profile');">Profile <i class="fa fa-user pull-right"></i> </a></li>
					...
					<?php if(  in_array(base64_decode(get_user_role()), array('1','2','3','4'))){ 
						...
						<li class="" id="leave_list" >
							<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<span class=" fa fa-bell"></span><span class="badge bg-info  pull-right"><?=$leaves; ?></span>
							</a>
							<ul class="dropdown-menu dropdown-usermenu pull-right" id="noti_list">
								<?php if(get_leave_applications() > 0) { ?>
									<li class="leave_note"> <a href="javascript:void(0);" onclick="javascript:gotolist('<?php echo base_url(); ?>index.php/Leave_Applications/','pending_leaves');" > <span class="badge bg-green"><?=$leaves; ?></span> New Leave Applications  <i class="pull-right fa fa-arrow-right" title="View All Leave Applications"></i> </a></li>
								<?php } ?>
							</ul>
						</li>
						-->
