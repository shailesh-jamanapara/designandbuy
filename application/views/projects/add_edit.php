				  ...
				  <form class="form-horizontal form-label-left" novalidate method="post" action="" id="editform" data-bv-message="This value is not valid" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" enctype="multipart/form-data">
					...
					<input type="hidden" name="limit" id="limit" value="<?php echo $postdata['limit']; ?>" />
					 <div class="row row-edit-form">
						<div class="col-lg-6"> 
							<label class="control-label col-lg-4 col-md-4 label-title-upper" for="project_name"><span class="requireds">*</span> Project Name:</label>
							<div class="col-lg-8 col-sm-6 col-xs-12 form-group">
									<input type="text" class="form-control" name="project_name" id="project_name" placeholder="Project name" value="<?php echo $row['project_name']; ?>"
									data-bv-notempty="true" data-bv-notempty-message="Please enter project name"  data-bv-regexp="true" data-bv-regexp-regexp="^[A-Za-z\ .]+$" data-bv-regexp-message="Special Characters are not allowed"
									>
							</div>
						</div>
					  </div>
					  <div class="row row-edit-form">
						<div class="col-lg-6"> 
							<label class="control-label col-lg-4 col-md-4 label-title-upper" for="project_short_description"><span class="requireds">*</span> Project Description:</label>
							<div class="col-lg-8 col-sm-6 col-xs-12 form-group">
									<textarea class="form-control" name="project_short_description" id="project_short_description" placeholder="Project short description"  data-bv-notempty="true" data-bv-notempty-message="Please enter project name"  data-bv-regexp="true" data-bv-regexp-regexp="^[A-Za-z\ .]+$" data-bv-regexp-message="Special Characters are not allowed"><?php echo $row['project_short_description']; ?></textarea>
							</div>
						</div>
					  </div>
					  <div class="row row-edit-form">
