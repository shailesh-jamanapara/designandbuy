				 ...
				 foreach($event_list as $row)
				  ...
				  ?>
					<tr>
					  ...
					  <td><?php echo $row['Events_Summary']; ?></td>
					  ...
					  <td><a href="<?php echo base_url();?>index.php/Event/edit_event/id=<?php echo $row['ID'];?>"><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-eye"></i> Detail</button></a></td>
					</tr>
					<?php }?>
