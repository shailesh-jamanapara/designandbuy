	  ...
	  <div class="">
		...
		<div class="row">
		  <div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
			    <div class="x_title">
				<h2>List of Earnings & Benefits</h2>
			  ...
			  <form class="form-horizontal" name="frmsearch" id="frmsearch" method="post" action="" >
				...
				<table class="table table-striped jambo_table bulk_action" >
					...
					<tr>
						...
						<th class="column-title col-lg-1 text-primary sortable" column="expenses.expense_name" state="none"  >Expense<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-1 text-primary sortable" column="expense_types.expense_type_name" state="none"  >Expense Type<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-3 sortable" column="expenses.expense_value_type" state="none"  >Flat / Percentage<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-2 sortable" column="expenses.expense_value" state="none"  >Per Month / Per Annum.<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-2 sortable" column="expenses.status" state="none" >Status<i   class="fa fa-sort-alpha-asc"> </i></th>
					...
					<tbody>
						...
						<td><?php echo  $i; ?></td>
							...
							<td><?php echo   $expense_types[$row['expense_type_id']];  ?></td>
							<td><?php
							if($row['expense_value_type'] == 'percentage'){
							echo  ucfirst($row['expense_value'])."%";
							if(isset($row['depend_on']) && $row['depend_on'] != ''){
							echo " On ". $expenses_all[$row['depend_on']];
							}
							}else{
							echo  ucfirst($row['expense_value_type']);
							}
							?>
							</td>
							<td>
							<?php echo $payable_modes[$row['payable_base']]; ?>
							</td>
							<td><?php echo $status; ?></td>
							<td> 
								<a herf="javascript:void(0);" class="edit_link" onclick="javascript:editrecord('<?php echo $id; ?>','<?= $edit_url ?>');" ><i class="fa fa-pencil-square-o text-success" title="Edit"> </i> </a>
