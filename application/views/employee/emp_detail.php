                ...
                <div class="row">
                    <div class="col-md-12">
                        <h2>
                            ...
                            echo "<strong>" . $emp_prefix . " " . ucfirst($Emp_info['First_Name']) . " " . ucfirst($Emp_info['Middle_Name']) . " " . ucfirst($Emp_info['Last_Name']) . ' ' . '(' . $Emp_info['Short_Name'] . ')</strong> - ' . $Position_Name . ' - ' . $Employeement_Status . ' - ' . $emp_status;
                            ?></h2>
                    </div>
                    <div class="col-md-4">                  
                    ...
                    <div class="col-md-4" >
                        <div class="demo-content">
                            <br><label>PERMANENT ADDRESS:&nbsp; </label><?php echo '<br>' . $Emp_info['Permanent_Address'] . ' ' . $Emp_info['Zipcode1']; ?>
                            <!-- <br><label>ZIPCODE1:&nbsp;</label><?php //echo $Emp_info['Zipcode1'];    ?> -->
                            <br><br><label>TEMPERORY ADDRESS:&nbsp;</label><?php echo '<br>' . $Emp_info['Address'] . ' ' . $Emp_info['Zipcode2']; ?>
                            ...
                            <br><br><label>PAST CRIMINAL RECORD DETAIL:&nbsp;&nbsp;</label><?php
                    ...
                    <div class="col-md-4" >
                        <div class="demo-content">
                            ...
                            <?php echo "<br/><label>EMERGANCY CONTACT NAME:</label>"; ?>
                            <?php
                            $emp_rel_str = '<ol>';
                            $emp_rel_str .= '<li>' . $Emp_info['Emergancy_Contact_Name1'] . ' (' . $Emp_info['Emergancy_Contact_Relation1'] . ')<br>' . $Emp_info['Emergancy_Contact_Number1'] . '</li><br>';
                            $emp_rel_str .= '<li>' . $Emp_info['Emergancy_Contact_Name2'] . ' (' . $Emp_info['Emergancy_Contact_Relation2'] . ')<br>' . $Emp_info['Emergancy_Contact_Number2'] . '</li>';
                            $emp_rel_str .= '</ol>';
                            ?>
                            <?php echo $emp_rel_str; ?>

                            <?php //echo "<br/><label>EMERGANCY CONTACT NAME 2:&nbsp;</label> ";   ?>
                            <?php //echo $Emp_info['Emergancy_Contact_Name2'];   ?>
                            <!-- 
...
//                            
                            ?> -->
                            <label>BLOOD GROUP:&nbsp;</label><?php echo $Emp_info['Blood_Group']; ?>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="demo-content" style="min-height:0px;">
                        <?php echo "<br/><label>REFERANCES:</label>"; ?>
                        <?php
                        $emp_refer_str = '<ol>';
                        if (!empty($Emp_info['Referance_Name_1']) || !empty($Emp_info['Referance_Relation_1']) || !empty($Emp_info['Referance_Number_1'])) {
                            $emp_refer_str .= '<li>' . $Emp_info['Referance_Name_1'] . ' (' . $Emp_info['Referance_Relation_1'] . ')<br>' . $Emp_info['Referance_Number_1'] . '</li><br>';
                        }
                        if (!empty($Emp_info['Referance_Name_2']) || !empty($Emp_info['Referance_Relation_2']) || !empty($Emp_info['Referance_Number_2'])) {
                            $emp_refer_str .= '<li>' . $Emp_info['Referance_Name_2'] . ' (' . $Emp_info['Referance_Relation_2'] . ')<br>' . $Emp_info['Referance_Number_2'] . '</li><br>';
                        }

                        if (!empty($Emp_info['Referance_Name_3']) || !!empty($Emp_info['Referance    _Relation_3']) || !empty($Emp_info['Referance_Number_3'])) {
                            $emp_refer_str .= '<li>' . $Emp_info['Referance_Name_3'] . ' (' . $Emp_info['Referance_Relation_3'] . ')<br>' . $Emp_info['Referance_Number_3'] . '</li>';
                        }
                        $emp_refer_str .= '</ol>';
                        ?>
                        <?php echo $emp_refer_str; ?>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">                  
                    <div class="demo-content" style="min-height:145px;">

                        <br><label>ESIC/INSURANCE NO:&nbsp;</label> <?php
                        ...
                        ?>
                        <br><label>PF CODE NO/UAN NO:&nbsp;</label><?php echo $Emp_info['Previous_PF_Code']; ?>
                        <!-- <br><label>NAME (AS PER AADHAR CARD):&nbsp;</label><?php //echo $Emp_info['Name_Aadhar']; ?> -->
                        <br><label>NAME :&nbsp;</label><?php echo $Emp_info['Name_Aadhar']; ?>
