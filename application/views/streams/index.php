			...
			<div class="x_panel">
			  ...
			  <form class="form-horizontal" name="frmsearch" id="frmsearch" method="post" action="" >
				...
				<table class="table table-striped jambo_table bulk_action" >
					...
					<tr>
						<th class="sorting column-title  col-lg-2" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" >Sr. No.</th>
						<th class="column-title col-lg-7 text-primary sortable" column="streams.stream_name" state="none"  >Stream Name<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-2 sortable" column="streams.status" state="none" >Status<i   class="fa fa-sort-alpha-asc"> </i></th>
