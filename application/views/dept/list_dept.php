		  ...
		  <div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
			  <div class="x_title">
				...
				<a  style="float: right;" href="<?php echo base_url();?>index.php/department/add_dept"><button type="button" class="btn btn-primary">  Add New Department</button></a>
			  ...
			  <div class="x_content">
				...
				<table id="datatable" class="table table-striped table-bordered">
				  ...
				  <tbody>
				   <?php 
				   if(!empty($dept_list) && isset($dept_list)) 
				   {
				   foreach($dept_list as $row) { ?>
					<tr>
					 ...
					 <a href="<?php echo base_url();?>index.php/department/edit_department/<?php echo $row['Dept_ID']; ?>"><button type="button" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-edit"></i></button></a>  
					  <a href="<?php echo base_url();?>index.php/department/delete_dept/<?php echo $row['Dept_ID']; ?>"><i class="glyphicon glyphicon-remove"></i></a>
