      ...
      <div class="row">
		<div class="box-body">
			...
			<a href="javascript:void(0);" onclick="javascript:editrecord('<?php echo $model['new']; ?>','<?= $edit_url ?>');">
				<button type="button" class="pull-right btn bg-orange btn-flat margin"> Add New School </button>
			</a>
		</div>
	  </div>
      <div class="row">
              ...
              <table id="example2" class="table table-bordered table-hover">
				<thead class="headings">
					<tr>
						...
						<th class="column-title col-lg-3 text-primary sortable" column="customers.customer_name" state="none"  >Name<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-3 sortable" column="customers.email" state="none"  >Email<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-2 sortable" column="customers.status" state="none" >Status<i   class="fa fa-sort-alpha-asc"> </i></th>
