				  ...
				  <form class="form-horizontal form-label-left" novalidate method="post" action="" id="editform" data-bv-message="This value is not valid" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" enctype="multipart/form-data">
					...
					<input type="hidden" name="limit" id="limit" value="<?php echo $postdata['limit']; ?>" />
					 <div class="row row-edit-form">
						<div class="col-lg-6"> 
							<label class="control-label col-lg-4 col-md-4 label-title-upper" for="country_name"><span class="requireds">*</span> Country Name:</label>
							<div class="col-lg-8 col-sm-6 col-xs-12 form-group">
									<input type="text" class="form-control" name="country_name" id="country_name" placeholder="Country name" value="<?php echo $row['country_name']; ?>"
									data-bv-notempty="true" data-bv-notempty-message="Please enter country name"
									>
							</div>
						</div>
					  </div>
					   <div class="row row-edit-form">
						<div class="col-lg-6"> 
							<label class="control-label col-lg-4 col-md-4 label-title-upper" for="country_icon"><span class="requireds">*</span> Short Code:</label>
							<div class="col-lg-8 col-sm-6 col-xs-12 form-group">
									<input type="text" class="form-control" name="country_icon" id="country_icon" placeholder="Short code" value="<?php echo $row['country_icon']; ?>"
									data-bv-notempty="true" data-bv-notempty-message="Please enter country short code"
									>
							</div>
						</div>
					  </div>
