			  ...
			  <form class="form-horizontal" name="frmsearch" id="frmsearch" method="post" action="" >
				...
				<table class="table table-striped jambo_table bulk_action" >
					...
					<tr>
						...
						<th class="column-title col-lg-3 text-primary sortable" column="states.state_name" state="none"  >State Name<i   class="fa fa-sort-alpha-asc"> </i></th>
						...
						<th class="column-title col-lg-2 sortable" column="states.status" state="none" >Status<i   class="fa fa-sort-alpha-asc"> </i></th>
