...
<div class="right_col" role="main">
 ...
 <form name="frmview" id="frmview" method="post" action="index.php">
                <input type="hidden" name="id" id="id" value="<?php if(isset($model['id'])) { echo base64_encode($model['id']); } ?>" />
 	...
 	<div class="col-md-12 col-sm-12 col-xs-12">
		<button id="send" type="button" class="btn btn-info pull-right" onclick="javascript:goback('<?php echo $model['id']; ?>','<?php echo base_url().'index.php/users/list_employees'; ?>');">Back</button>
		<button  type="button" class="btn btn-success pull-right" onclick="javascript:toggle_modal_assignrole('<?php echo base64_encode($model['id']); ?>', '<?php echo $row['role_id']; ?>');">Assign Role</button>
		<button  type="button" class="btn btn-success pull-right" onclick="javascript:toggle_modal_change_password('<?php echo base64_encode($model['id']); ?>');">Change Password</button>
		<div class="tab-content clearfix">
		<span class="section tab-title-upper"> Employee Detail</span>
				<div class="row">	
					<div class="item col-lg-12 col-md-1 col-sm-3 col-xs-12 users_avatar text-center">
					 <img src="<?php echo base_url(); ?><?php echo $row['avatars']['active']; ?>" class="user-avatar" name="" id="" title="">
						
					</div>	
				</div>
				
		<div class="row" >
					<div class="item col-lg-12 col-md-1 col-sm-3 col-xs-12 text-center">
						<h4 id="profile_name">
						...
						<h5>
							...
							if($row['employment_status'] == '2')
									$employment_status = "Part-time";
							if($row['active_status'] == '1'){
								$active_status = "Active ";
								$active_status_cls = 'text-success';
							}
							if($row['active_status'] == '0'){
								$active_status = "Inactive";	
								$active_status_cls = 'text-danger';
							}
									
								
						?>
						<i class="fa fa-briefcase tag-1"></i> <?php echo $row['position_name']; ?> 
						, <i class="fa fa-clock-o tag-1"></i> <small class="user_tag_1"> <?php echo $employment_status; ?> </small>   -  <small class="user_tag_1 <?php echo $active_status_cls ;?> " id="small_active_status"> <?php echo $active_status; ?> </small> 
						
						</h5>
						<h5 id="employee_status">
							<?php if(isset($row['role_id']) && $row['role_id']!= 0 ){ ?><i class="fa fa-users tag-1" ></i> <?php echo $roles[$row['role_id']];} ?> 
						</h5>
					</div>	
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12 ">
						<fieldset class="well demo-content" id="fs_personal_info">
						<legend class="well-legend"> Personal Information</legend>
						<?php if(isset($employee_record_accesses['personal_info']) && $employee_record_accesses['personal_info']['edit'] == 1 ){ ?><button type="button" name="btn1" id="btn1" class="btn btn-success edit-btn pull-right" data-toggle="modal" data-target="#modal_personal_info" title="Edit Personal Information"><i class="fa fa-pencil" > </i></button> <?php } ?>
						<?php if(isset($employee_record_accesses['personal_info']) && $employee_record_accesses['personal_info']['view'] == 1 ){ ?>
						<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Name </label>
						<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" id="div_name" >
							<?php echo $row['title']; ?> <?php echo $row['first_name']; ?> <?php echo $row['middle_name']; ?> <?php echo $row['last_name']; ?> 
						</div>
						...
						<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Blood Group </label>
						<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" id="div_blood_group">
						...
						<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" id="div_email_secondary">
						...
						<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" id="div_aadhar_no">
							<?php echo substr($row['aadhar_no'], 0,4)."-".substr($row['aadhar_no'], 4,4)."-".substr($row['aadhar_no'], 8,4);?>
						</div>
						...
						<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" id="div_pan">
						 ...
						 <?php } ?>
						 <?php if(isset($employee_record_accesses['personal_info']) && $employee_record_accesses['personal_info']['view'] == 0 ){ ?>
							<div class="col-lg-12 access_denied text-center" ><i class="fa fa-warning"></i>
								</div>
							<div class="col-lg-12 text-center" >
								Personal Information Is Not Accessible. Please contact admin to access this.
								</div>	
						  <?php } ?>
					  </fieldset>
					</div>	
					...
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12 ">
						<fieldset class="well demo-content" id="fs_profile_info">
							<legend class="well-legend">Profile</legend>
							<?php if(isset($employee_record_accesses['profile']) && $employee_record_accesses['profile']['edit'] == 1 ){ ?><button type="button" name="btn2" id="btn_edit_profile" class="btn btn-success edit-btn pull-right" data-toggle="modal" data-target="#modal_profile" title="Edit Profile"><i class="fa fa-pencil" > </i></button> <?php } ?>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Employee Code</label>
							<?php if(isset($employee_record_accesses['profile']) && $employee_record_accesses['profile']['view'] == 1 ){ ?>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" id="div_username">
								<?php echo $row['username'];?>
							</div>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Position  </label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group"  id="div_position_id">
								<?php  if(isset( $row['position_name'])) echo  $row['position_name']; else echo 'NA' ;?>
							</div>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Department  </label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" id="div_department_id">
								<?php  if(isset($row['department_name'])) echo  $row['department_name']; else echo 'NA' ;?>
							</div>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Manager </label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" title="<?php echo $row['reporting_manager_id']; ?>"id="div_reporting_manager">
								<?php $manager =(isset($row['reporting_manager_id']) && isset($managers[$row['reporting_manager_id']])  ) ? $managers[$row['reporting_manager_id']] :"Not Assigned"; echo  $manager; ?>
							</div>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Email <small  class="">(OFFICIAL)</small>  </label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group"  id="div_email">
								<a href="mailto:<?php echo $row['official_email'];?>" title="Email to : <?php echo $row['official_email'];?>"><i class="fa fa-envelope-o fa_evelope" > </i> <?php echo $row['official_email'];?></a>
								
							</div>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Skype <small  class="">(OFFICIAL)</small></label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group"  id="div_skype_id">
								<?php if(isset($row['skype_id'])) { ?>
											<a href="skype:<?php echo $row['skype_id'];?>" title="Skype call to : <?php echo $row['skype_id'];?>?call"> <i class="fa fa-skype fa_skype" > </i> <?php echo $row['skype_id'];?></a>
								<?php } else { 
											echo "Not Available" ;
										}?>
							</div>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Employment Type </label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group"  id="div_employment_status">
								<?php echo $employment_status ;?>
							</div>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">ORDINARY WORKING HOURS </label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" >
									<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 form-group">
											<strong>FROM </strong>
									</div>
									<div class="col-lg-4 col-md-1 col-sm-3 col-xs-12 form-group" id="div_working_hours_from">
											<?php echo $row['working_hours_from'];?>
									</div>
									<div class="col-lg-2 col-md-1 col-sm-3 col-xs-12 form-group">
											<strong>TO </strong>
									</div>
									<div class="col-lg-4 col-md-1 col-sm-3 col-xs-12 form-group" id="div_working_hours_to" >
											<?php echo $row['working_hours_to'];?>
									</div>
								</div>
								<?php } ?>
						 <?php if(isset($employee_record_accesses['profile']) && $employee_record_accesses['profile']['view'] == 0 ){ ?>
							<div class="col-lg-12 access_denied text-center" ><i class="fa fa-warning"></i>
								</div>
							<div class="col-lg-12 text-center" >
								Personal Information Is Not Accessible. Please contact admin to access this.
					...
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12">
						<fieldset class="well demo-content" id="fs_official_info">
							<legend class="well-legend">Official Information </legend>
							<?php if(isset($employee_record_accesses['official_info']) && $employee_record_accesses['official_info']['edit'] == 1 ){ ?><button type="button" name="btn1" id="btn3" class="btn btn-success edit-btn pull-right" data-toggle="modal" data-target="#modal_official_info"><i class="fa fa-pencil"  title="Edit Official Information"> </i></button> <?php } ?>
							<?php if(isset($employee_record_accesses['official_info']) && $employee_record_accesses['official_info']['view'] == 1 ){ ?>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">DATE OF EMPLOYMENT </label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" id="div_joining_date">
								<?php echo date('M d Y', strtotime($row['joining_date']));?>
							</div>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Months of Bond : </label>
							<div class="col-lg-2 col-md-1 col-sm-3 col-xs-12 form-group" id="div_bond_period">
							<?php echo $row['bond_period'];?> 
							</div>
							<div class="col-lg-3 col-md-1 col-sm-3 col-xs-12 form-group" id="div_bond_to_date">
							<?php if(isset($row['bond_to_date']) && ($row['bond_to_date'] != '' || $row['bond_to_date'] != null) ) echo date('M d Y', strtotime($row['bond_to_date'])); else echo date('d M Y', strtotime('+'.$row['bond_period'].' months')); ?>
							</div>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Insurance Policy No. </label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" id="div_insurance_no">
								<?php if(isset($row['insurance_no']) && $row['insurance_no'] != '' ) echo $row['insurance_no']; else echo "Not Available"; ?>
							</div>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">PF CODE NO/UAN NO : </label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" id="div_pf_code_no">
							<?php if(isset($row['pf_code_no']) && $row['pf_code_no'] != '') echo $row['pf_code_no']; else echo "Not Available"; ?>
							</div>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Date of Exist  </label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" id="div_date_of_exit">
							<?php if(isset($row['date_of_exit'])) echo date('d M Y', strtotime($row['date_of_exit'])); else echo "Not Available"; ?>
							</div>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper">Past Criminal Record </label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group" id="div_past_criminal_record">
								<?php if($row['past_criminal_record'] == 1) echo "Yes"; else echo "No";?>
								<?php if($row['past_criminal_record'] == 1) { ?>
										<i class="fa fa-eye" title="View Past Criminal Detail" data-toggle="modal" data-target="#modal_past_criminal_detail" > </i>	
										<!-- Modal for Past Criminal Detail -->
										<div class="modal" tabindex="-2" role="dialog" id="modal_past_criminal_detail">
										  <div class="modal-dialog" role="document">
											<div class="modal-content">
											  <div class="modal-header">
												<h4 class="modal-title">Past Criminal Detail</h4>
												<h5 class="modal-title"><?php echo $row['first_name'] . " " . $row['last_name'] ;?> </h5>
												<button type="button" class="close" data-dismiss="modal" aria-label="Close">
												  <span aria-hidden="true">&times;</span>
												</button>
											  </div>
											  <div class="modal-body" id="div_past_criminal_detail">
												<p>
													<?php echo $row['past_criminal_detail'];?>
												</p>
											   </div>
											</div>
										  </div>
							...
							<!-- 
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper"> Resume :</label>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group">
								<button type="button" name="btn1" id="btn1" class="btn btn-info btn-edit-pic" data-toggle="modal" data-target="#modal_resume"><i class="fa fa-file" title="Download Resume"> </i></button>
							</div>
							-->
							<?php } ?>
						 <?php if(isset($employee_record_accesses['official_info']) && $employee_record_accesses['official_info']['view'] == 0 ){ ?>
							<div class="col-lg-12 access_denied text-center" ><i class="fa fa-warning"></i>
								</div>
							<div class="col-lg-12 text-center" >
								Official information is not accessible. Please contact admin to access this.
								</div>	
						  <?php } ?>
						</fieldset>
					</div>		
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12 ">
						<fieldset class="well demo-content" id="fs_contact_info">
							...
							<?php if(isset($employee_record_accesses['contact_info']) && $employee_record_accesses['contact_info']['edit'] == 1 ){ ?><button type="button" name="btn1" id="btn4" class="btn btn-success edit-btn pull-right" data-toggle="modal" data-target="#modal_contacts_info" title="Edit Address & Contacts"><i class="fa fa-pencil" > </i></button><?php }?>
							<label class="col-lg-6 col-md-2 col-sm-3 col-xs-12 label-title-upper"> Permanent Address :</label>
							<?php if(isset($employee_record_accesses['contact_info']) && $employee_record_accesses['contact_info']['view'] == 1 ){ ?>
							<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group">
							...
							<label class="col-lg-12 col-md-2 col-sm-3 col-xs-12 label-title-upper"> References Contact:</label>
								...
								<?php 	}?>	
									<?php } ?>
						 <?php if(isset($employee_record_accesses['contact_info']) && $employee_record_accesses['contact_info']['view'] == 0 ){ ?>
							<div class="col-lg-12 access_denied text-center" ><i class="fa fa-warning"></i>
								</div>
							<div class="col-lg-12 text-center" >
								Address & Contacts is not accessible. Please contact admin to access this.
								</div>	
						  <?php } ?>	
						</fieldset>
					</div>	
					<div class="item col-lg-12 col-md-5 col-sm-3 col-xs-12 ">
						<fieldset class="well demo-content" id="fs_employers_list">
						
							<?php if(isset($employee_record_accesses['employers']) && $employee_record_accesses['employers']['edit'] == 1 ){ ?><button type="button" name="btn1" class="btn btn-success pull-right add_new_item" onclick="javascript:toggle_modal_employers(0, '<?php echo $model['id']; ?>');" title="Add New"><i class="fa fa-plus" > </i></button><?php } ?>
							<legend class="well-legend">Employment History </legend>
							<?php if(isset($employee_record_accesses['employers']) && $employee_record_accesses['employers']['view'] == 1 ){ ?>
								...
								<?php }//  end if ?>	
								<?php } ?>
								<?php if(isset($employee_record_accesses['employers']) && $employee_record_accesses['employers']['view'] == 0 ){ ?>
									<div class="col-lg-12 access_denied text-center" ><i class="fa fa-warning"></i></div>
									<div class="col-lg-12 text-center" >
									Employment History is not accessible. Please contact admin to access this.
									</div>	
								<?php } ?>	
						</fieldset>
					</div>	
					<div class="item col-lg-12 col-md-5 col-sm-3 col-xs-12 ">
						<fieldset class="well demo-content" id="fs_degree_list">
							<?php if(isset($employee_record_accesses['qualifications']) && $employee_record_accesses['qualifications']['edit'] == 1 ){ ?><button type="button" name="btn1" class="btn btn-success pull-right add_new_item" onclick="javascript:toggle_modal('modal_qualifications', 0);" title="Add New"><i class="fa fa-plus" > </i></button><?php } ?>
							<legend class="well-legend">Qualifications </legend>
							<?php if(isset($employee_record_accesses['qualifications']) && $employee_record_accesses['qualifications']['view'] == 1 ){ ?>
								<div class="form-group col-lg-12 col-md-1 col-sm-3 col-xs-12 ">
									...
									<?php $_id = $arr['users_educational_qualifications_id']; ?>
										<div class="col-lg-12 col-md-1 col-sm-3 col-xs-12 " id="row_degree_list_<?php echo $arr['users_educational_qualifications_id']; ?>">
											...
											<?php //if( isset($my_acceses['users_educational_qualifications']) && $my_acceses['users_educational_qualifications']['edit_entity'] == '1') { ?>
												<button type="button" name="btn1" 	 class="btn btn-warning pull-right edit_item" onclick="javascript:toggle_modal('modal_qualifications', <?php echo $arr['users_educational_qualifications_id']; ?>);" title="Edit this record"><i class="fa fa-pencil" > </i></button>
											 <?php //}//  end if ?>	
											 <?php $obj_resp = array('response' => $arr); ?>
								...
								<?php }//  end if ?>	
								<?php } ?>
								<?php if(isset($employee_record_accesses['qualifications']) && $employee_record_accesses['qualifications']['view'] == 0 ){ ?>
									<div class="col-lg-12 access_denied text-center" ><i class="fa fa-warning"></i></div>
									<div class="col-lg-12 text-center" >
									Qualifications is not accessible. Please contact admin to access this.
									</div>	
								<?php } ?>
						</fieldset>
					</div>	
					...
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12 ">
						<fieldset class="well demo-content">
							...
							<?php if(isset($employee_record_accesses['family_detail']) && $employee_record_accesses['family_detail']['view'] == 1 ){ ?>
							<label class="col-lg-12 col-md-2 col-sm-3 col-xs-12 label-title-upper"> Family Members: 
									<?php if(isset($employee_record_accesses['family_detail']) && $employee_record_accesses['family_detail']['add'] == 1 ){ ?><button type="button" name="btn1" id="btn_1" class="btn btn-success add-btn pull-right" title="Add Family Member" onclick="javascript:toggle_modal_family('0', '<?php echo $model['id'];?>');"><i class="fa fa-plus" > </i></button><?php } ?>
							</label>
							...
							<?php if (count($row['family']) > 0) { $i = 1;?>
								<?php  foreach ($row['family'] as $key => $val) {?>
										<div class="col-lg-11 col-lg-offset-1" id="row_family_list_<?php echo $val['users_family_id'];?>" >
											...
											<label class="col-lg-5 col-md-2 col-sm-3 col-xs-12 label-title-upper" id="users_family_relation_id<?php echo $val['users_family_id'];?>"> <?php echo $val['relation_name'];?> </label>
											
											<div class="col-lg-5 col-md-1 col-sm-3 col-xs-12 form-group " title="Edit Family Member" >
												<span id="users_family_full_name<?php echo $val['users_family_id'];?>">
												<?php echo $val['full_name'];?>
												</span>
												<small class="margin-left" id="users_family_relation_type<?php echo $val['users_family_id'];?>" ><?php if(isset($val['relation_type']) && $val['relation_type'] != '') { echo "[ ".ucfirst($val['relation_type'])." ] "; }?>  </small>
											</div>
							...
							<label class="col-lg-12 col-md-2 col-sm-3 col-xs-12 label-title-upper"> Emergency Contacts:
								<?php if ((isset($row['emergency']) && count($row['emergency']) < 2) || !isset($row['emergency'])) { ?>
									<?php if(isset($employee_record_accesses['family_detail']) && $employee_record_accesses['family_detail']['add'] == 1 ){ ?><button type="button" name="btn1" id="btn_1" class="btn btn-success add-btn pull-right" title="Add Emergency Contact" onclick="javascript:toggle_modal_emergency_contact('0', '<?php echo $model['id'];?>');"><i class="fa fa-plus" > </i></button><?php } ?>
								<?php } ?>	
							</label>
								<div class="row" id="div_users_emergency_contacts_list">
									...
									<?php if(isset($row['emergency'][1]['full_name']) && isset($row['emergency'][1]['users_emergency_contacts_id'])) { ?>
										<div class="col-lg-5 col-md-1 col-sm-3 col-xs-12 form-group no-label" id="emergency_contacts_name_<?php echo $row['emergency'][1]['users_emergency_contacts_id']; ?>" >
											<?php
												echo " ". $row['emergency'][1]['full_name']." [ ". $row['emergency'][1]['relation']." ] ";
											?>		
										</div>		
										<div class="col-lg-5 col-md-1 col-sm-3 col-xs-12 form-group no-label" id="emergency_contacts_no_<?php echo $row['emergency'][1]['users_emergency_contacts_id']; ?>">	
								...
								<?php } ?>
								<?php if(isset($employee_record_accesses['family_detail']) && $employee_record_accesses['family_detail']['view'] == 0 ){ ?>
									<div class="col-lg-12 access_denied text-center" ><i class="fa fa-warning"></i></div>
									<div class="col-lg-12 text-center" >
									Family Detail & Emergency Contacts are not accessible. Please contact admin to access this.
									</div>	
								<?php } ?>
						</fieldset>
					</div>
					...
					<div class=" col-lg-5 col-md-12 col-sm-4 col-xs-12">
							  <div class="x_panel">
								...
								<div class="x_content">
								  <div class="dashboard-widget-content profile-widget-content">
									...
									<?php if (isset($row['documents'])) {?>
										...
										<div class="block">
										  <div class="block_content">
												<div class="col-lg-6">
													<h5> <?php echo $i .". " .$val['document_name'];?></h5>
												</div>
												<div class="col-lg-5 byline">
													Uploaded on <span><?php echo date('d M Y', strtotime($val['created_at']));?> </span></a>
												</div>
												<div class="col-lg-1">
												<a href="javascript:void(0);" class="doc-link" onclick="download_doc('<?php echo $val['id'];?>', '<?php echo $model['id']; ?>');" title="<?php echo $on_date ; ?>">
					...
					-->	
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12 ">
						<fieldset class="well demo-content" id="fs_documents_list">
						<div class="row" >
								<?php if(isset($employee_record_accesses['documents']) && $employee_record_accesses['documents']['edit'] == 1 ){ ?><button type="button" name="btn1" id="btn_1" class="btn btn-success add-btn pull-right"  data-toggle="modal" data-target="#modal_upload" ><i class="fa fa-plus" > </i></button><?php } ?>
							</div>
							<legend class="well-legend">Documents</legend>
							<?php if(isset($employee_record_accesses['documents']) && $employee_record_accesses['documents']['view'] == 1 ){ ?>
							<div class="row" >
								<ul class="ul_documents_list">
									<?php if (isset($row['documents'])) {?>
										<?php if (count($row['documents']) > 0) { $i = 1;?>
											<?php  foreach ( $row['documents'] as $key => $val) {
												$on_date = "Download ".$row['first_name']." ".$row['last_name']."'s ". $val['document_name'];

											?><li id="row_<?php echo $val['id'];?>_1">
												<div class="block">
												  <div class="block_content">
														<div class="col-lg-6">
															<h5> <?php echo $val['document_name'];?></h5>
														</div>
														<div class="col-lg-4 byline">
															Uploaded on <span> <?php echo date('d M Y', strtotime($val['created_at']));?> </span> </a>
														</div>
														<div class="col-lg-1">
														<a href="javascript:void(0);" class="doc-link" onclick="download_doc('<?php echo base64_encode($val['id']);?>', '<?php echo base64_encode($model['id']); ?>');" title="<?php echo $on_date ; ?>">
															<i class="fa fa-download " aria-hidden="true"></i> 
														</a>
														</div>
														<div class="col-lg-1">
														
														<a href="javascript:void(0);" class="doc-link" onclick="remove_doc('<?php echo base64_encode($val['id']);?>', '<?php echo base64_encode($model['id']); ?>','row_<?php echo$val['id'];?>_1');" title="Remove This Document">
							...
							<?php } ?>
								<?php if(isset($employee_record_accesses['documents']) && $employee_record_accesses['documents']['view'] == 0 ){ ?>
									<div class="col-lg-12 access_denied text-center" ><i class="fa fa-warning"></i></div>
									<div class="col-lg-12 text-center" >
									Documents are not accessible. Please contact admin to access this.
									</div>	
								<?php } ?>
							</fieldset>
					</div>
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12 ">
						<fieldset class="well demo-content" id="fs_skill_list">
						<div class="row" >
								<?php if(isset($employee_record_accesses['skills']) && $employee_record_accesses['skills']['edit'] == 1 ){ ?><button type="button" name="btn1" id="btn_1" class="btn btn-info add-btn pull-right"  data-toggle="modal" data-target="#modal_skills" ><i class="fa fa-pencil" > </i></button><?php } ?>
							</div>
							<legend class="well-legend">Skills</legend>
							<?php if(isset($employee_record_accesses['skills']) && $employee_record_accesses['skills']['view'] == 1 ){ ?>
							<div class="row tagsinput" >
								<?php if (isset($row['skills'])) {?>
								<?php  $arr_skills  = (array) json_decode($row['skills']); ?>
										<?php  foreach ( $arr_skills as $key => $val) {
											?>
											<div class="col-lg-3 tag"><?php echo $skills[$val];?></div>
							...
							<?php } ?>
								<?php if(isset($employee_record_accesses['skills']) && $employee_record_accesses['skills']['view'] == 0 ){ ?>
									<div class="col-lg-12 access_denied text-center" ><i class="fa fa-warning"></i></div>
									<div class="col-lg-12 text-center" >
									Documents are not accessible. Please contact admin to access this.
									</div>	
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<form name="frm_upload" id="frm_upload" method="post" enctype="multipart/form-data" data-bv-message="This value is not valid"
		 ...
		 <input type="hidden" name="id" id="id" value="<?php echo base64_encode($model['id']);  ?>" />				
		 <input type="hidden" name="users_documents_id" id="users_documents_id" value="0" />
			<div class="row">
			<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
					 <label class="control-label col-lg-4 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="password" id="lbl_dob">Document Type<span class="requireds">*</span> </label>
					 <div class="col-lg-7 col-md-1 col-sm-3 col-xs-12 form-group">   
							<select  class="form-control col-md-7 col-xs-12" id="document_id" name="document_id" data-bv-notempty="true" data-bv-notempty-message="Please select document type">
			...
			<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
					 <label class="control-label col-lg-4 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="password" id="lbl_dob">File<span class="requireds">*</span> </label>
					 <div class="col-lg-7 col-md-1 col-sm-3 col-xs-12 form-group">   
							<input required data-bv-notempty="true" data-bv-notempty-message="Please choose file" type="file" class="form-control custom-file-input" id="document" name="document">
					</div>
			</div>		 
			</div>		 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
				 <label class="control-label col-lg-4 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="password" id="lbl_dob">Confirm Password<span class="requireds">*</span> </label>
				 <div class="col-lg-7 col-md-1 col-sm-3 col-xs-12 form-group">   
							<input id="confirm_password" name="confirm_password" class="form-control col-md-7 col-xs-12" type="password" placeholder="Confirm Password" required >
				</div>
		</div>
		<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12"></div>
		<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
...
<div class="modal" tabindex="-2" role="dialog" id="modal_personal_info">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
	  <h4> <?php echo $row['first_name'] . " " . $row['last_name'] ;?> </h4>
	  <fieldset class="well demo-content">
		<legend class="well-legend-popup">Update Personal Info </legend>
		<form class="form-horizontal form-label-left" novalidate method="post" action="" id="frm_personal_info"
			...
			<div class="row"> 
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
					<label class="control-label col-lg-3 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="first_name" id="lbl_dob">Title<span class="requireds">*</span> </label>
					<div class="col-lg-2 col-md-1 col-sm-3 col-xs-12 form-group">   
							<select class="form-control col-lg-2 " id="title" name="title">
							   ...
							   <option value="Dr"<?php if ( $row['title'] == "Dr" ) { ?> selected="selected"<?php } ?>>Dr.</option>
							   <option value="Prof"<?php if ( $row['title'] == "Prof" ) { ?> selected="selected"<?php } ?>>Prof.</option>
							</select>						
					</div>
					<label class="control-label col-lg-3 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="first_name" id="lbl_dob">First Name<span class="requireds">*</span> </label>
					...
					<label class="control-label col-lg-3 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="first_name" id="lbl_dob">Middle Name<span class="requireds">*</span> </label>
					...
					<label class="control-label col-lg-2 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="first_name" id="lbl_dob">Last Name<span class="requireds">*</span> </label>
					<div class="col-lg-4 col-md-1 col-sm-3 col-xs-12 form-group">   
				...
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
				 <label class="control-label col-lg-3 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="dob" id="lbl_dob">Date of Birth<span class="requireds">*</span> </label>
				 <div class="col-lg-2 col-md-1 col-sm-3 col-xs-12 form-group">   
							<input <?php echo $data_bv['dob']; ?> id="dob" name="dob" value="<?php echo $row['dob'];?>" class="date-picker form-control col-md-7 col-xs-12 " onChange="GetNextDate();"  type="text" placeholder="eg. mm/dd/yyyy" >
						<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>						
					</div>
					 <div class="col-lg-1 col-md-1 col-sm-3 col-xs-12 "> 
						[mm/dd/yyyy]
					 </div>
					<label class="control-label col-lg-2 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="blood_group" id="lbl_dob">Blood Group<span class="requireds">*</span> </label>
				 <div class="col-lg-3 col-md-1 col-sm-3 col-xs-12 form-group">   
				...
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12 ">
						 <label class="control-label col-lg-3 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="marital_status">Marital Status<span class="requireds">*</span> </label>
						 <div class="col-lg-9 col-md-1 col-sm-3 col-xs-12 form-group pull-right">   
				 ...
				 <div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
						 ...
						 <div class="col-lg-9 col-md-2 col-sm-3 col-xs-12 form-group">   
				...
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
					<label class="control-label col-lg-3 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="email">Email <small>[Personal] </small></label>
					<div class="col-lg-5 col-md-1 col-sm-3 col-xs-12 form-group">   
						<input type="email" class="form-control" name="email" id="email" placeholder="Personal Email" value="<?php echo $row['email']; ?>" <?php echo $data_bv['email']; ?>>						
					</div>
				</div>
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
					<label class="control-label col-lg-3 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="aadhar_name">Full Name <small>[AS PER AADHAR ] </small></label>
					<div class="col-lg-5 col-md-1 col-sm-3 col-xs-12 form-group">   
				...
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
					<label class="control-label col-lg-3 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="aadhar_no">Aadhar Card Number</label>
					<div class="col-lg-5 col-md-1 col-sm-3 col-xs-12 form-group">   
				...
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
					<label class="control-label col-lg-3 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="pan">PAN</label>
					<div class="col-lg-5 col-md-1 col-sm-3 col-xs-12 form-group">   
...
<div class="modal" tabindex="-2" role="dialog" id="modal_profile">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
	  <h4> <?php echo $row['first_name'] . " " . $row['last_name'] ;?> </h4>
	  <fieldset class="well demo-content">
		<legend class="well-legend-popup">Update Profile </legend>
		...
		<form class="form-horizontal form-label-left" novalidate method="post" name="frm_profile" action="" id="frm_profile"
			...
			<div class="row"> 
				...
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
				 ...
				 <div class="col-lg-7 col-md-1 col-sm-3 col-xs-12 form-group">   
							<select class="form-control" id="reporting_manager_id" name="reporting_manager_id"   data-bv-notempty="true"  data-bv-notempty-message="Please select one">
				...
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
					<label class="control-label col-lg-4 col-md-0 col-sm-0 col-xs-0 label-title-upper" for="official_email">Email <small>[
					Official] </small></label>
					<div class="col-lg-7 col-md-1 col-sm-3 col-xs-12 form-group">   
						<input type="email" class="form-control" name="official_email" id="official_email" placeholder="Official Email ID" value="<?php echo $row['official_email']; ?>" data-bv-notempty="true"  data-bv-notempty-message="Please enter official Email ID">						
					</div>
				</div>
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
				...
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12 ">
				 ...
				 <div class="col-lg-7 col-md-1 col-sm-3 col-xs-12 form-group pull-left">   
							<label class="control-label label-title-upper">
...
<div class="modal" tabindex="-2" role="dialog" id="modal_official_info">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
	  <h4> <?php echo $row['first_name'] . " " . $row['last_name'] ;?> </h4>
	  <fieldset class="well demo-content">
		<legend class="well-legend-popup">Update Official Information </legend>
...
<div class="modal" tabindex="-2" role="dialog" id="modal_contacts_info">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
	  <h4> <?php echo $row['first_name'] . " " . $row['last_name'] ;?> </h4>
	  <fieldset class="well demo-content">
		<legend class="well-legend-popup">Update Address & Contacts </legend>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
	   <h4> <?php echo $row['first_name'] . " " . $row['last_name'] ;?> </h4>
	  <fieldset class="well demo-content">
		<legend class="well-legend-popup">Update Family Detail </legend>
            ...
            <input type="hidden" name="users_family_id" id="users_family_id"   value="" />
     		<div class="row"> 
				...
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
					...
					<div class="col-lg-4 col-md-1 col-sm-3 col-xs-12 form-group">   
							<select  class="form-control col-md-7 col-xs-12" id="relation_type" name="relation_type">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
	   <h4> <?php echo $row['first_name'] . " " . $row['last_name'] ;?> </h4>
	  <fieldset class="well demo-content">
		<legend class="well-legend-popup">Update Emergency Contact </legend>
...
<div class="modal" tabindex="-2" role="dialog" id="modal_qualifications">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
	  <h4> <?php echo $row['first_name'] . " " . $row['last_name'] ;?> </h4>
		...
		<fieldset class="well demo-content">
		<legend class="well-legend-popup">Update  Educational Qualifications</legend>
		 <form class="form-horizontal form-label-left" novalidate method="post" name="frm_qualifications" action="" id="frm_qualifications"
            ...
            <input type="hidden" name="qualification_or_skill"   value="qualification_or_skill" value="1" />
			...
			<div class="col-lg-2 col-md-1 col-sm-4 col-xs-12 form-group " id="div_training">   	
			 ...
			 <div class="row">   	
				...
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12" id="div_degree_name">
					...
					<div class="col-lg-3 col-md-1 col-sm-3 col-xs-12 form-group">   
						<select class="form-control col-md-7 col-xs-12" id="stream_id" name="stream_id" >
						<option value="">--  Select --</option>
...
<div class="modal" tabindex="-2" role="dialog" id="modal_skills">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
	  <h4> <?php echo $row['first_name'] . " " . $row['last_name'] ;?> </h4>
		<fieldset class="well demo-content">
		<legend class="well-legend-popup"> Update Skills</legend>
		<form class="form-label-left" novalidate method="post" name="frm_skills" action="" id="frm_skills" >
			...
			<input type="hidden" name="users_skills_id" id="users_skills_id" value="<?php if(isset($row['users_skills_id'])) { echo $row['users_skills_id']; } else { echo '0';} ?>" />
			<div class="row">
				 <div class="">
						<label class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-12">Select Skills</label>
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
						  <select class="select2_multiple " id="skills" name="skills[]" multiple="multiple">
							<?php foreach($skills as $key => $val){ ?> <option value="<?php echo $key; ?>" <?php if( isset( $arr_skills ) && is_array( $arr_skills ) && in_array($key,  $arr_skills )) echo 'selected="selected"'; ?>><?php echo $val; ?></option> <?php }?>
						  </select>
						</div>
					  </div>
			</div>
...
$(document).ready(function() {
	...
	$('input#username').on('change', function(){
		$('small.custom_err_username').remove();
	});
	$('input#email').on('change', function(){
		$('small.custom_err_email').remove();
	});
	$('input#official_email').on('change', function(){
		$('small.custom_err_oficial_email').remove();
	});
		...
		$.post(url, $form.serialize(), function(result) {
			...
			if(obj.status == 'success'){
				if( update_personal_info(obj)) 
					$("#modal_personal_info").modal('toggle');
			}
			if(obj.status == 'failed'){
				var arr = obj.message.split('^');
				if($('#custom_err_msg')){
					$('#custom_err_msg').remove();
				}
				var arr = result.split('^');
				var cls = 'custom_err_'+arr[1];
				var err ='<small class="help-block error_email '+cls+' " data-bv-validator="emailAddress" data-bv-for="email" data-bv-result="INVALID" style="display: block;" display="block"> '+arr[2]+' </small>';
	...
	$('#frm_profile').bootstrapValidator().on('success.form.bv', function(e) {
		...
		$.post(url, $form.serialize(), function(result) {
			...
			if(obj.status == 'failed'){
				...
				var cls = 'custom_err_'+arr[1];
				var err ='<small class="help-block error_email '+cls+' " id="custom_err_msg" data-bv-validator="emailAddress" data-bv-for="email" data-bv-result="INVALID" style="display: block;" display="block"> '+arr[2]+' </small>';
				$("input#"+arr[1]).parent('div.form-group ').append(err);
				$("input#"+arr[1]).parent('div.form-group ').addClass('has-error');
				return false;
			}
	...
	$('#frm_contacts_info').bootstrapValidator().on('success.form.bv', function(e) {
		...
		$.post(url, $form.serialize(), function(result) {
			...
			$("#modal_contacts_info").modal('toggle');
	...
	//Edit Educational Qualifications
		...
		$.post(url, $form.serialize(), function(result) {
			if(result != ''){
				...
				if(obj.status == 'success' ){
					...
					if( obj.task == 'add' ){
						var onclick="javascript:toggle_modal('modal_qualifications', "+obj.response.users_educational_qualifications_id+");";
			...
			$("#modal_qualifications").modal('toggle');
				...
				if(obj.response.task == "add"){
					...
					var html = '<div class="col-lg-11 col-lg-offset-1" id="row_family_list_9">';
							...
							html = html+'<div class="col-lg-5 col-md-1 col-sm-3 col-xs-12 form-group " title="Edit Family Member">';
								...
								if( obj.response.relation_type != '' || obj.response.relation_type != 'None' )
	 ...
	 $('#frm_upload').bootstrapValidator().on('success.form.bv', function(e) {
		// Prevent form submission
		e.preventDefault();
		var data = new FormData();
		$.each($('#document')[0].files, function(j,file){
			data.append('document', file);
		});
		data.append('id','<?php echo base64_encode($model['id']);  ?>');
		data.append('document_id',$('select#document_id').val());
		var url =  '<?php echo $ajax_url; ?>uploadDoc';
		$.ajax({
			url: url,
			data : data,
			cache : false,
			...
			success: function(result){
				...
				setTimeout(function() {$('#modal_upload').modal('hide');}, 1500);
			}
		});
	});
	 $('#frm_skills').bootstrapValidator().on('success.form.bv', function(e) {
		// Prevent form submission
		e.preventDefault();
		var url =  '<?php echo $ajax_url; ?>updateSkills';
		var $form = $(e.target);
		var bv = $form.data('bootstrapValidator');
		// Use Ajax to submit form data
		$.post(url, $form.serialize(), function(result) {
			...
			if(obj.status == 'success'){
				$('div#modal_skills div.row').prepend(message);
				$('div.tagsinput').html('');
				$('div.tagsinput').html(obj.response);
			}
			setTimeout(function() {$('#modal_skills').modal('hide');}, 1500);
		});
	});
...
function validateEmployeeCode(val, id){
	var url = '<?php echo $ajax_url; ?>checkEmployeeDuplicateCode';
		// Use Ajax to submit form data
		$.post(url, {'id' : id, 'value' : val}, function(result){
			if(result == 'invalid'){
				$('input#username').val('');
				$('input#username').removeAttr('value');
				// $('#frm_official_info').bootstrapValidator('revalidateField', 'username');
...
function validateEmail(val, id){
	var url = '<?php echo $ajax_url; ?>checkEmployeeDuplicateEmail';
		...
		$.post(url, {'id' : id, 'value' : val}, function(result){
			if(result == 'invalid'){
				$('input#email').val('');
				$('input#email').removeAttr('value');
				// $('#frm_personal_info').bootstrapValidator('revalidateField', 'email');
			}
		});
}
function validateOfficialEmail(val, id){
...
function toggle_modal(modal_id, id){
		...
		if( Number(id)  !=  0 ){
			...
			if(qual_obj.response){
				...
				$("form#frm_qualifications").find("select#duration_from_month option[value="+qual_obj.response.duration_from_month+"]").attr('selected','selected');
				$("form#frm_qualifications").find("#duration_from_year").val(qual_obj.response.duration_from_year);
				$("form#frm_qualifications").find("select#duration_to_month option[value="+qual_obj.response.duration_to_month+"]").attr('selected','selected');
				$("form#frm_qualifications").find("#duration_to_year").val(qual_obj.response.duration_to_year);
...
function update_contact_info(json_string){
	if(json_string){
		...
		$('input#users_contacts_id').val(obj.response.users_contacts_id);
			...
			_html = _html+ '<button type="button" name="btn1" id="btn_10" class="btn btn-success edit-btn pull-right" data-toggle="modal" data-target="#modal_contacts_info" title="Edit Address &amp; Contacts"><i class="fa fa-pencil"> </i></button>';
			...
			for(i=1;i<4;i++){
				_html = _html+'<div class="col-lg-6 col-md-1 col-sm-3 col-xs-12 form-group no-label"> '+i+'. '+refs[1][1][i]+' '+refs[2][1][i]+' ,'+refs[3][1][i]+' </div> <div class="col-lg-5 col-md-1 col-sm-3 col-xs-12 form-group no-label"> '+refs[4][1][i]+' </div>	';
...
function update_personal_info(obj){
	...
	$("h4#profile_name").text('');
	$("h4#profile_name").text(obj.response.name);
	return true;
}
			...
			$.post(url, {users_family_id : users_family_id, id: user_id}, function(result) {
				...
				if(family_obj.status == 'success'){
					if(family_obj.response){
						...
						if(family_obj.response.relation_type && family_obj.response.relation_type != '')
...
function fade_in_out_stream(val){
	var url =  '<?php echo $ajax_url; ?>getQualificatinsStreamFlag';
	$.post(url, {qualifications_id :val}, function(result) {
		var obj = $.parseJSON(result);
		if(obj.status == 'success'){
			if(obj.response.stream_id == '0' ){
				$("#stream_id").removeAttr('required');
			}
			if(obj.response.stream_id == '1' ){
				$("#stream_id").attr('required', 'required');
			}
		}
	});
}
function toggle_modal_upload_doc(users_documents_id){
	//$("form#document").find("input#users_documents_id").val(users_documents_id);
...
function remove_doc(document_id, id, row_id){
	if(confirm('Are you sure to remove this document ? ') ){
		var url =  '<?php echo $ajax_url; ?>deleteDocument';
        $.post(url,{document_id : document_id, id}, function(result){
            var obj = $.parseJSON(result);
            if(obj.status == 'success'){
              var cache =  $("li#"+row_id);
			  ...
			  if(obj.count == '0' ){
				 $('ul.ul_documents_list').append('<li class="text-center text-danger"> No Document Found </li>'); 
			  }		
            }
        }); 
	}
}
function update_documents(json_string){
	var _html = '';
	if(json_string){
		var obj = $.parseJSON(json_string);
		var dn_url = "download_doc('"+obj.response.users_documents_id+"', '"+obj.response.user_id+"');";
		var remove_url = "remove_doc('"+obj.response.users_documents_id+"', '"+obj.response.user_id+"');";
		_html = _html+ '<li id="row_3_1">';
				_html = _html+ '<div class="block">';
					_html = _html+ '<div class="block_content">';
						_html = _html+ '<div class="col-lg-6">';
							_html = _html+ '<h5> '+obj.response.document_type+' </h5>';
						_html = _html+ '</div>';
						_html = _html+ '<div class="col-lg-4 byline">';
							_html = _html+ '  <span>  Uploaded on '+obj.response.uploaded_on+'  </span> ';
						_html = _html+ '</div>';
						_html = _html+ '<div class="col-lg-1">';
							_html = _html+ '<a href="javascript:void(0);" class="doc-link"  onclick="'+dn_url+'  "title="Download David Peterson`s '+obj.response.document_type+'">';
							_html = _html+ '<i class="fa fa-download " aria-hidden="true"></i> ';
							_html = _html+ '</a>';
						_html = _html+ '</div>';
						_html = _html+ '<div class="col-lg-1">';
							_html = _html+ '<a href="javascript:void(0);" class="doc-link" onclick="'+remove_url+'" title="Remove This Document">';
							_html = _html+ '<i class="fa fa-trash " aria-hidden="true"></i> ';
							_html = _html+ '</a>';
						_html = _html+ '</div>';
					_html = _html+ '</div>';
				_html = _html+ '</div>';
