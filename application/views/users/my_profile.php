...
<div class="right_col" role="main">
 ...
 <form name="frmview" id="frmview" method="post" action="index.php">
 	...
 	<div class="col-md-12 col-sm-12 col-xs-12">
		<a class="pull-right" href="javascript:void(0);" onclick="javascript:editrecord('<?php echo base64_encode(0) ; ?>','<?= $apply_leave_url ?>');"  ><button type="button" class="btn btn-primary">  Apply For New Leave</button></a>	
		...
		<span class="section tab-title-upper"> Employee Detail</span>
				<div class="row">	
					<div class="item col-lg-12 col-md-1 col-sm-3 col-xs-12 users_avatar text-center">
					 <img src="<?php echo base_url(); ?><?php echo $loggedin['avatar']; ?>" class="user-avatar" name="my_profile" id="my_profile" title="Click to change profile picture" onclick="javascript:toggle_modal_upload_pic();">
		...
		<div class="row" >
					...
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12 ">
						...
						<button type="button" name="btn1" id="btn1" class="btn btn-success edit-btn pull-right" data-toggle="modal" data-target="#modal_personal_info" title="Edit Personal Information"><i class="fa fa-pencil" > </i></button>
					...
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12 ">
						<fieldset class="well demo-content" id="fs_profile_info">
							...
							<button type="button" name="btn2" id="btn_edit_profile" class="btn btn-success edit-btn pull-right" data-toggle="modal" data-target="#modal_profile" title="Edit Profile"><i class="fa fa-pencil" > </i></button>
					...
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12">
						<fieldset class="well demo-content" id="fs_official_info">
							...
							<button type="button" name="btn1" id="btn3" class="btn btn-success edit-btn pull-right" data-toggle="modal" data-target="#modal_official_info"><i class="fa fa-pencil"  title="Edit Official Information"> </i></button>
					...
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12 ">
						<fieldset class="well demo-content" id="fs_contact_info">
							...
							<button type="button" name="btn1" id="btn4" class="btn btn-success edit-btn pull-right" data-toggle="modal" data-target="#modal_contacts_info" title="Edit Address & Contacts"><i class="fa fa-pencil" > </i></button>
					...
					<div class="item col-lg-12 col-md-5 col-sm-3 col-xs-12 ">
						<fieldset class="well demo-content" id="fs_degree_list">
							...
							<button type="button" name="btn1" class="btn btn-success pull-right add_new_item" onclick="javascript:toggle_modal('modal_qualifications', 0);" title="Add New"><i class="fa fa-plus" > </i></button>
					...
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12 ">
						...
						<div class="row" >
								<button type="button" name="btn1" id="btn_1" class="btn btn-success add-btn pull-right"  data-toggle="modal" data-target="#modal_upload" ><i class="fa fa-plus" > </i></button>
							</div>
					...
					<div class="item col-lg-6 col-md-5 col-sm-3 col-xs-12 ">
						...
						<div class="row" >
								<button type="button" name="btn1" id="btn_1" class="btn btn-info add-btn pull-right"  data-toggle="modal" data-target="#modal_skills" ><i class="fa fa-pencil" > </i></button>
							</div>
...
<!-- Modal for upload profile Picture -->
<div class="modal" tabindex="-1" role="dialog" id="modal_upload_pic">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
		...
		<form name="frm_upload_pic" id="frm_upload_pic" method="post" enctype="multipart/form-data" data-bv-message="This value is not valid"
					data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" action="">
			<input type="hidden" name="id" id="id" value="<?php echo base64_encode($model['id']);  ?>" />				
			<div class="row">
				<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12">
				 <div class="col-lg-7 col-md-1 col-sm-3 col-xs-12 form-group">   
					<input required data-bv-notempty="true" data-bv-notempty-message="Please upload .jpg, .jpeg, p.ng file only" type="file" class="form-control custom-file-input" id="users_avatar" name="users_avatar">
				</div>
				</div>		 
			</div>		 
			<div class="item form-group col-lg-12 col-md-1 col-sm-3 col-xs-12"></div>
...
$(document).ready(function() {
	...
	$('#frm_upload_pic').bootstrapValidator().on('success.form.bv', function(e) {
		// Prevent form submission
		e.preventDefault();
		var data = new FormData();
		$.each($('#users_avatar')[0].files, function(j,file){
			data.append('users_avatar', file);
		});
		data.append('id','<?php echo base64_encode($model['id']);  ?>');
		var url =  '<?php echo $ajax_url; ?>uploadPic';
		$.ajax({
			url: url,
			data : data,
			cache : false,
			...
			success: function(result){
				var obj = $.parseJSON(result);
				if(obj.status == 'failed'){
					alert('Please chhose .jpg, .jpeg or .png image only');
					return false;
				}
				if(obj.status == 'success'){
					var image_url = '<?php echo base_url(); ?>/uploads/'+obj.fullpath;
					console.log(image_url);
					$('img#my_profile').attr('src',image_url);
				}
				setTimeout(function() {$('#modal_upload_pic').modal('hide');}, 1000);
			}
		});
	});
...
function toggle_modal_upload_pic(){
	//$("form#document").find("input#users_documents_id").val(users_documents_id);
	$("#modal_upload_pic").modal('toggle');
}
