			  ...
			  <form class="form-horizontal" name="frmsearch" id="frmsearch" method="post" action="" >
				...
				<table class="table table-striped jambo_table bulk_action" >
					...
					<tr>
						...
						<th class="column-title col-lg-5 text-primary sortable" column="documents.document_name" state="none"  >Document Name<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-1 sortable" column="documents.status" state="none" >Status<i   class="fa fa-sort-alpha-asc"> </i></th>
					...
					<tbody>
						...
						<tr  id="tr_<?php echo $row['id']; ?>">
							...
							<td> <a herf="javascript:void(0);" class="edit_link" onclick="javascript:editrecord('<?php echo $id; ?>','<?= $edit_url ?>');" ><i class="fa fa-pencil-square-o" title="Edit"> </i> </a>
								<a herf="javascript:void(0);" class="edit_link" onclick="javascript:conf_delete('<?php echo $id; ?>');" ><i class="fa fa-trash" title="Delete This Item"> </i> </a>
							</td>
						</tr>
