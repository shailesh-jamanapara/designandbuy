      ...
      <div class="row">
		<div class="box-body">
			...
			<a href="javascript:void(0);" onclick="javascript:editrecord('<?php echo $model['new']; ?>','<?= $edit_url ?>');">
				<button type="button" class="pull-right btn bg-orange btn-flat margin"> Add New Option </button>
			</a>
		</div>
	  </div>
      <div class="row">
              ...
              <table id="example2" class="table table-bordered table-hover">
				<thead class="headings">
					<tr>
						...
						<th class="column-title col-lg-3 text-primary sortable" column="attribute_options.attribute_option_name" state="none"  >Option Name<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-3 text-primary sortable" column="attributes.attribute_name" state="none"  >Parent Attribute Name<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-2 sortable" column="attribute_options.is_required" state="none" >Is Required<i   class="fa fa-sort-alpha-asc"> </i></th>
						<th class="column-title col-lg-2 sortable" column="attribute_options.status" state="none" >Status<i   class="fa fa-sort-alpha-asc"> </i></th>
					...
					<tbody>
						...
						<?php  $is_required = ( $row['is_required'] == 1) ?"Yes":"No"; ?>
						<tr id="<?php echo $row_id; ?>">
						<td><?php echo  $i; ?></th>
									<td><?php echo  $row['attribute_option_name'];  ?></td>
									<td><?php echo  $row['attribute_name'];  ?></td>
									<td><?php echo  $is_required;  ?></td>
									<td><?php
									echo $status; ?></td>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-validator/0.5.3/js/bootstrapValidator.min.js"></script>	<!-- Content Header (Page header) -->