...
<link href="<?php echo asset_url(); ?>plugins/plugin-css/plugin-sticky-classes.min.css" id="colour-scheme" rel="stylesheet">
      ...
      chemical <span class="text-primary font-weight-bold">Cards</span>
      </h2>
      <div class="row  ml-1 mb-1">
      <div class="col-lg-4">
      <a class="mb-1 btn btn-outline-orange btn-rounded border-w-2 px-5 py-2 <?php if(isset($request['orientation']) && $request['orientation'] == 'vertical') echo 'active' ;?>" href="<?php echo base_url(); ?>id-cards/chemical-card.html?orientation=vertical">Vertical</a> 
      
    
        
     
      <a class="mb-1 btn btn-outline-orange btn-rounded border-w-2 px-5 py-2  <?php if(isset($request['orientation']) && $request['orientation'] == 'horizontal') echo 'active' ;?>"  href="<?php echo base_url(); ?>id-cards/chemical-card.html?orientation=horizontal">Horizontal</a> 
                    ...
                    <?php foreach($vertical_cards as $card){?>
                      ...
                      <div class="card mb-3 product-card overlay-hover px-3 py-3">
                        ...
                        <div class="overlay-hover-content overlay-op-7">
                          <a href="<?php echo base_url();?>product-info/chemical-id-card?template=<?php echo $card['id'];?>" class="btn btn-secondary btn-rounded btn-shadow font-weight-bold mb-3 btn-lg px-5 py-3"> Get started</a>
                        </div>
                        <!-- Image & price content -->
