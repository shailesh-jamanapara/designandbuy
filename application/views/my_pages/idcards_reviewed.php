...
<input type="hidden" class="template_ids" value="<?php echo $my_templates[$row['customer_templates_id']]['templates_id']; ?>" id="" name="template_ids_<?php echo $row['id'];?>">
                     ...
                     <?php  if(empty($rows)) : ?>
                        ...
                        <td colspan="8"  >
					<div class="row">
						<div class="col-lg-12 text-center text-secondary bordered mb-2">No record found.</div>
						...
						<div class="col-lg-4 text-center text-secondary">
   ...
   $.ajax({
        ...
        success: function(result){
            ...
            if(result.status == 'success'){
               $('div.filter-part').css('display','none');
               $('div#div_proceed_order').css('display','none');
               $('div#div_pagination').css('display','none');
               $('div#idcards').html('<h5 class="text-success text-center"> Thank you for ordering. We will contact you soon</h5>');
             //return false;
            }
        }
    });
