...
<div class="row">
   ...
   <?php endif; ?>
   <?php  if(empty($rows)) : ?>
              	<div class="col-lg-12  font-weight-light text-small text-default mb-2 mt-2 text-center">No record found.</div>
						<div class="col-lg-12  font-weight-light text-small text-default text-center mb-3 mt-2">I-Cards which are in process will be shown here.</div>
				<?php endif; ?>
<?php  if(!empty($rows)) : ?>
