...
<div class="row">
	...
	<h5 class="text-left my-0 sub-title text-dark">
		My Account  &nbsp;<i class="fas fa-angle-right"></i>&nbsp; Action &nbsp;<i class="fas fa-angle-right"></i>&nbsp; <span class="text-white">Buy lace for I-Cards</span>
	</h5>
	</div>
	<div class="col-lg-12">
				...
				<div class="col-lg-7 col-sm-12 pb-2" >
					<div class="input-group input-group-sm  mb-2 form-group">
						...
						<?php foreach($my_templates as $template){?>
							...
							<option value="<?php echo $template['id']; ?>" ><?php echo $template['template_unique_id']; ?></option>
							<?php 
							}
						?>
						</select>
