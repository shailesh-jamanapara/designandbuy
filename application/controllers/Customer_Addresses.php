...
class Customer_Addresses Extends Designandbuy_Controller {
    ...
    private function initLoad() {
       ...
       $this->{$this->model_name}->table_properties['cross_fields']['customer_name'] = array(
        ...
        $this->web['postdata']['sort_by'] = (isset($this->web['request']['sort_by'])) ? $this->web['request']['sort_by'] : 'customers.customer_name';
        $this->web['postdata']['order_type'] = (isset($this->web['request']['order_type'])) ? $this->web['request']['order_type'] : 'ASC';
        $this->web['search']['customer.customer_name'] = 'First Name';
        $this->web['search'][$this->_model . 'address'] = 'Address';
        $this->web['search']['states.state_name'] = 'State';
        $this->web['search']['cities.city_name'] = 'City';
        $this->web['search']['zipcode'] = 'Zip code';
    ...
    public function add_edit() {
        ...
        if (isset($this->web['request']['task']) && ($this->web['request']['task'] == 'add_edit')) {
            ...
            if ($this->web['model']['id'] > 0) {
                $this->{$this->model_name}->where[0] = $this->_model . ".id= " . $this->web['model']['id'];
            }
        }
