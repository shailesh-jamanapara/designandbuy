...
class Customer_Contacts Extends Designandbuy_Controller {
    ...
    private function initLoad() {
        ...
        $this->{$this->model_name}->table_properties['join_tables'][] = array('customers', 'customers.id = ' . $this->_model . '.customer_id ', 'right');
        ...
        $this->web['search']['customers.customer_name'] = 'Name';
        $this->web['search'][$this->_model . 'phone'] = 'Phone No';
        $this->web['search'][$this->_model . 'mobile_1'] = 'Mobile';
