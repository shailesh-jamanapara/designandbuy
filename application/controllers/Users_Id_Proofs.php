...
class Users_Id_Proofs Extends Designandbuy_Controller {
    ...
    private function initLoad() {
        ...
        $this->{$this->model_name}->table_properties['cross_fields']['username'] = array(
            'caption' => array('first_name ', 'username ', 'username   of Employee'),
            'type' => 'varchar',
            'len' => 100,
            'value' => null,
            'in_select' => 1,
        ...
        $this->web['search']['users.first_name'] = 'Employee Code';
...
//        $condArr[0] = 'users.user_type="employee" and users.active_status="1" and users.is_archived="0"  ';
        $this->users_model->where["users.user_type"] = "employee";
        $this->users_model->where["users.active_status"] = "1";
        $this->users_model->where["users.is_archived"] = "0";
        $this->web['employees'] = $this->users_model->getAllWithKeyValue();
